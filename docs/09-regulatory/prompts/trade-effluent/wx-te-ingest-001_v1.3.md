# WX-TE-INGEST-001 v1.3
## Wessex Water Trade Effluent Consent Ingestion Prompt

**Version:** 1.3
**Status:** FROZEN
**Regulator:** Wessex Water
...
You are processing a **Trade Effluent Consent** document issued by **Wessex Water** for discharge of trade effluent to the public sewer system.
...
### Key Identifiers
- Consent Reference Number (Wessex Water format)
- SPID (Supply Point ID)
- Premises Address
- Discharge Point Reference

### Coverage Area
Wessex Water serves the South West of England:
- Dorset, Somerset, most of Wiltshire
- Parts of Gloucestershire, Hampshire
...
```json
{
  "consent_reference": "string — Wessex Water consent number",
...
## Section 4: Trade Effluent-Specific Rules (Wessex Water)

### Mogden Formula Values [WX-TE-001]
Wessex Water uses the Mogden formula for charging. Extract if stated:
...
### Discharge Hour Restrictions [WX-TE-002]
Extract discharge time windows exactly as specified:
- Mix of urban and rural works
- Discharge restrictions may vary significantly

### Pre-Treatment Requirements [WX-TE-003]
...
### Prohibited Substances [WX-TE-004]
Extract all prohibited substance lists verbatim:
- Standard Wessex Water prohibited list if referenced
...
| REPORTING | "Submit [report_type] to Wessex Water by [deadline]" |
...
Extract ONLY from provided document text. If consent references Wessex Water standard conditions without reproducing them, note the reference but do not populate values.
...
{
  "extraction_metadata": {
    "prompt_id": "WX-TE-INGEST-001",
    "prompt_version": "1.3",
    "extraction_timestamp": "ISO 8601",
    "document_hash": "SHA-256",
    "water_company": "WESSEX_WATER",
...
- [ ] Premises address within Wessex Water service area
- [ ] Receiving works is valid Wessex Water facility
...
|-------------|-----------------|---------|
| [WX-TE-001] | Wessex Water Trade Effluent Charges Scheme | 2024 |
| [WX-TE-002] | Trade Effluent Consent Standard Conditions | 2023 |
| [WX-TE-003] | Pre-treatment Requirements Guidance | 2023 |
| [WX-TE-004] | Prohibited Substances List | 2024 |

---

## Appendix A: Common Wessex Water Sewage Treatment Works

- Avonmouth STW (Bristol)
- Poole STW
- Bournemouth STW
- Bath STW
- Salisbury STW
...
```text
You are an expert Wessex Water trade effluent analyst. Your task is to extract data from Trade Effluent Consent documents for discharges to the Wessex Water sewer system.

JURISDICTION: South West England (Dorset, Somerset, most of Wiltshire, parts of Gloucestershire and Hampshire).
...
OUTPUT: Return valid JSON matching the WX-TE-INGEST-001 v1.3 schema.
```
...
```text
Extract all data from this Wessex Water Trade Effluent Consent.
...
Return valid JSON matching the WX-TE-INGEST-001 v1.3 schema.
```

---

**END OF PROMPT WX-TE-INGEST-001 v1.3**
