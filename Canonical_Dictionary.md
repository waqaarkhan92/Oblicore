...
* Examples: Company, Site, Obligation, EvidenceItem, AuditPack
...
Entity Name: AuditPack

Purpose: A compiled PDF document containing compliance evidence for regulator inspection.
...
* Pack type (module 1, module 2, module 3, combined)

Relationships:

* Many AuditPacks belong to One Document

* One AuditPack generated by One User
...
pack_type	TEXT	NOT NULL, CHECK	NO	-	Pack type (validated against modules.module_code or 'COMBINED')

title	TEXT	NOT NULL	NO	-	Audit pack title
...
* `CONSULTANT`: Multi-company access; Staff permissions across client companies
...
* `AUDIT_PACK_GENERATION`: Generate audit pack PDF
...
PLS Reference: Section I.7 (Audit Pack Generation Triggers)
...
Context: Users generate audit packs on-demand or scheduled. Contains obligations, evidence, and compliance status.
...
- All modules: Users receive notifications, generate audit packs
